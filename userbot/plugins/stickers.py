...
async def _(event):
    ...
    packname = f"Hack12RStickers"
    packshortname = f"Hack12R_Ki_Bank_Me"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"Hack12RAnimated"
        if userid == 719877937:
            packshortname = "Hack12R_Animated"
        else:
            packshortname = f"Hack12R_Animated" # format: Uni_Borg_userid
